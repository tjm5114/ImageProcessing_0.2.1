...
{
    public partial class SobelEdgeDetectorParmForm : ParmFormBase
    {
        private SobelEdgeDetectorParms mParms = new SobelEdgeDetectorParms();
        public SobelEdgeDetectorParmForm()
        {
            InitializeComponent();
        ...
        public SobelEdgeDetectorParms Parms
        {
            get
            {
                return mParms;
